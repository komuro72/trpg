...
const GLOBAL_COMBAT:      Array[String] = ["aggressive", "defensive", "standby", "follow", "retreat"]
const GLOBAL_TARGET:      Array[String] = ["nearest", "weakest", "focus"]
...
const GLOBAL_HP_POTION:   Array[String] = ["50pct", "25pct", "never"]
const GLOBAL_SP_MP_POTION: Array[String] = ["save", "aggressive"]

## OrderWindow 個別指示オプション値（非ヒーラー）
const MEMBER_FORMATION:    Array[String] = ["surround", "front", "rear", "same_as_leader"]
const MEMBER_COMBAT:       Array[String] = ["aggressive", "support", "standby"]
const MEMBER_ATTACK_TARGET: Array[String] = ["nearest", "weakest", "same_as_leader"]
const MEMBER_SPECIAL:      Array[String] = ["auto", "manual"]
## OrderWindow 個別指示オプション値（ヒーラー専用）
const MEMBER_HEAL:         Array[String] = ["aggressive", "support", "standby"]
